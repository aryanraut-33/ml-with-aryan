'use client'; // This is the single client boundary for the page.
...
import SortToggle from 'components/SortToggle'; // The toggle is now inside this component
  ...
  return (
    <>
      <div className={styles.header}>
        ...
        {/* The SortToggle is now safely inside the client component */}
      </div>
      <SortToggle />
